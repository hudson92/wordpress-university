...
class PostContent {
    ...
    private $block_name = 'getwid/template-post-content';
    ...
    public function __construct() {
        ...
        register_block_type(
            ...
            array(
                ...
                'render_callback' => [ $this, 'render_template_post_content' ],
            )
        );
    }

    public function render_template_post_content( $attributes, $content ) {
