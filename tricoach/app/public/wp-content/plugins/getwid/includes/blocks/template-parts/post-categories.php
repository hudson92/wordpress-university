...
class PostCategories {
    ...
    private $block_name = 'getwid/template-post-categories';
    ...
    public function __construct() {
        ...
        register_block_type(
            ...
            array(
                ...
                'render_callback' => [ $this, 'render_template_post_categories' ]
            )
        );
    }

    public function render_template_post_categories( $attributes, $content ) {
