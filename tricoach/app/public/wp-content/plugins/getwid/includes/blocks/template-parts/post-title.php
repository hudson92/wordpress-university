...
class PostTitle {
    ...
    private $block_name = 'getwid/template-post-title';
    ...
    public function __construct() {
        ...
        register_block_type(
            ...
            array(
                ...
                'render_callback' => [ $this, 'render_template_post_title' ]
            )
        );
    }

    public function render_template_post_title( $attributes, $content ) {
